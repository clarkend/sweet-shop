...
INSERT INTO product(product_name, product_description, created_date, last_updated_date) VALUES
    ...
    ('Foam Bananas', 'Yellow Foam Banana shaped sweets with a scrumptious fruity taste. They have a foam texture and are a soft sweet.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Chocolate Limes', 'A zesty, crunchy lime candy casing enveloping a creamy chocolate centre. These traditional, individually wrapped, sweets have been a favourite for over a hundred years!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
